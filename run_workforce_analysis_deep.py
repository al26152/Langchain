#!/usr/bin/env python3
"""
Workforce Model Transformation Analysis - Deep Iteration
Integrated Neighborhood Healthcare Systems
Higher iteration count for deeper evidence exploration
"""
...
print('\n' + '='*80)
print('WORKFORCE MODEL TRANSFORMATION ANALYSIS (DEEP ITERATION)')
print('Integrated Neighbourhood Healthcare Systems')
print('='*80)
print('\n[SETUP] Initializing multi-agent system with higher iterations...\n')

embeddings = OpenAIEmbeddings()
db = Chroma(persist_directory='chroma_db_test', embedding_function=embeddings)
orchestrator = Orchestrator(db, max_iterations=6, verbose=False)
...
2. NEIGHBORHOOD DEFINITION & STRUCTURE: If piloting an integrated neighborhood model, how should neighborhoods be defined (population size, geography, services, boundaries)? What are best practices and evidence-based approaches for neighborhood definition in integrated systems?
...
Please synthesize evidence from policy, strategic plans, and implementation guidance across the documents to provide a comprehensive framework."""

print('[EXECUTING] Running comprehensive 6-phase deep analysis...\n')

# Run wide-then-deep analysis with higher iterations
result = orchestrator.run_wide_then_deep_analysis(query)

# SAVE COMPREHENSIVE REPORT
output_file = 'WORKFORCE_INTEGRATED_CARE_ANALYSIS_DEEP.md'
with open(output_file, 'w', encoding='utf-8') as f:
    f.write('# Workforce Model Transformation for Integrated Neighbourhood Healthcare\n\n')
    f.write('## Strategic Analysis Report (Deep Iteration)\n\n')
    f.write(f'**Analysis Date:** 31 October 2025\n')
    f.write(f'**Analysis Type:** Deep Multi-Agent Exploration (6 iterations)\n')
